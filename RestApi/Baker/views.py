    ...
    def get(self, request, test_er):
        try:
            ...
            data = {
                ...
                "popupEnergia": {
                    "kw_a": round(promedio.kw_a, 2),
                    "kw_b": round(promedio.kw_b, 2),
                    "kw_c": round(promedio.kw_c, 2),
                    "kw_avg": round(promedio.kw_avg, 2),
                    "kvar_a": round(promedio.kvar_a, 2),
                    "kvar_b": round(promedio.kvar_b, 2),
                    "kvar_c": round(promedio.kvar_c, 2),
                    "kvar_avg": round(promedio.kvar_avg, 2),
                    "kva_a": round(promedio.kva_a, 2),
                    "kva_b": round(promedio.kva_b, 2),
                    "kva_c": round(promedio.kva_c, 2),
                    "kva_avg": round(promedio.kva_avg, 2),
                    "fp_a": round(promedio.pf_a, 2),
                    "fp_b": round(promedio.pf_b, 2),
                    "fp_c": round(promedio.pf_c, 2),
                    "fp_avg": round(promedio.pf_a, 2),
                    "v_a": round(promedio.ab, 2),
                    "v_b": round(promedio.bc, 2),
                    "v_c": round(promedio.ca, 2),
                    "v_avg": round(promedio.avg, 2),
                    "i_a": round(promedio.current_a, 2),
                    "i_b": round(promedio.current_b, 2),
                    "i_c": round(promedio.current_c, 2),
                    "i_avg": round(promedio.current_avg, 2),
                    "thdv_a": round(promedio.thdv_a, 2),
                    "thdv_b": round(promedio.thdv_b, 2),
                    "thdv_c": round(promedio.thdv_c, 2),
                    "thdv_avg": round(promedio.thdv_avg, 2),
                    "thdi_a": round(promedio.thdi_a, 2),
                    "thdi_b": round(promedio.thdi_b, 2),
                    "thdi_c": round(promedio.thdi_c, 2),
                    "thdi_avg": round(promedio.thdi_avg, 2),
